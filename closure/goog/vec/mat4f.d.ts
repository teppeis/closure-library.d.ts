...
declare module goog.vec.mat4f {
     ...
     *     chained.
     */
    function makeRotationTranslation(mat: goog.vec.mat4f.Type, rotation: goog.vec.Quaternion.AnyType, translation: goog.vec.vec3f.Type): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeRotationTranslationScale(mat: goog.vec.mat4f.Type, rotation: goog.vec.Quaternion.AnyType, translation: goog.vec.vec3f.Type, scale: goog.vec.vec3f.Type): goog.vec.mat4f.Type;
     ...
     *     chained.
     */
    function makeRotationTranslationScaleOrigin(mat: goog.vec.mat4f.Type, rotation: goog.vec.Quaternion.AnyType, translation: goog.vec.vec3f.Type, scale: goog.vec.vec3f.Type, origin: goog.vec.vec3f.Type): goog.vec.mat4f.Type;
