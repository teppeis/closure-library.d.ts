declare module goog.vec.mat4d {
     ...
     */
    export function create(): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function setFromValues(mat: goog.vec.mat4d.Type, v00: number, v10: number, v20: number, v30: number, v01: number, v11: number, v21: number, v31: number, v02: number, v12: number, v22: number, v32: number, v03: number, v13: number, v23: number, v33: number): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function setFromMat4d(mat: goog.vec.mat4d.Type, src: goog.vec.mat4d.Type): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function setFromMat4f(mat: goog.vec.mat4d.Type, src: Float32Array): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function setFromArray(mat: goog.vec.mat4d.Type, src: Array<number>): goog.vec.mat4d.Type;
     ...
     */
    export function getElement(mat: goog.vec.mat4d.Type, row: number, column: number): number;
     ...
     *     chained together.
     */
    export function setElement(mat: goog.vec.mat4d.Type, row: number, column: number, value: number): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function setDiagonalValues(mat: goog.vec.mat4d.Type, v00: number, v11: number, v22: number, v33: number): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function setDiagonal(mat: goog.vec.mat4d.Type, vec: goog.vec.vec4d.Type): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function getDiagonal(mat: goog.vec.mat4d.Type, vec: goog.vec.vec4d.Type, opt_diagonal?: number): goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    export function setColumnValues(mat: goog.vec.mat4d.Type, column: number, v0: number, v1: number, v2: number, v3: number): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function setColumn(mat: goog.vec.mat4d.Type, column: number, vec: goog.vec.vec4d.Type): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function getColumn(mat: goog.vec.mat4d.Type, column: number, vec: goog.vec.vec4d.Type): goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    export function setColumns(mat: goog.vec.mat4d.Type, vec0: goog.vec.vec4d.Type, vec1: goog.vec.vec4d.Type, vec2: goog.vec.vec4d.Type, vec3: goog.vec.vec4d.Type): goog.vec.mat4d.Type;
     ...
     */
    export function getColumns(mat: goog.vec.mat4d.Type, vec0: goog.vec.vec4d.Type, vec1: goog.vec.vec4d.Type, vec2: goog.vec.vec4d.Type, vec3: goog.vec.vec4d.Type): void;
     ...
     *     chained together.
     */
    export function setRowValues(mat: goog.vec.mat4d.Type, row: number, v0: number, v1: number, v2: number, v3: number): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function setRow(mat: goog.vec.mat4d.Type, row: number, vec: goog.vec.vec4d.Type): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function getRow(mat: goog.vec.mat4d.Type, row: number, vec: goog.vec.vec4d.Type): goog.vec.vec4d.Type;
     ...
     *     chained together.
     */
    export function setRows(mat: goog.vec.mat4d.Type, vec0: goog.vec.vec4d.Type, vec1: goog.vec.vec4d.Type, vec2: goog.vec.vec4d.Type, vec3: goog.vec.vec4d.Type): goog.vec.mat4d.Type;
     ...
     */
    export function getRows(mat: goog.vec.mat4d.Type, vec0: goog.vec.vec4d.Type, vec1: goog.vec.vec4d.Type, vec2: goog.vec.vec4d.Type, vec3: goog.vec.vec4d.Type): void;
     ...
     */
    export function makeZero(mat: goog.vec.mat4d.Type): goog.vec.mat4d.Type;
     ...
     * @return {!goog.vec.mat4d.Type} return mat so operations can be chained.
     */
    export function makeIdentity(mat: goog.vec.mat4d.Type): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function addMat(mat0: goog.vec.mat4d.Type, mat1: goog.vec.mat4d.Type, resultMat: goog.vec.mat4d.Type): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function subMat(mat0: goog.vec.mat4d.Type, mat1: goog.vec.mat4d.Type, resultMat: goog.vec.mat4d.Type): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function multScalar(mat: goog.vec.mat4d.Type, scalar: number, resultMat: goog.vec.mat4d.Type): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function multMat(mat0: goog.vec.mat4d.Type, mat1: goog.vec.mat4d.Type, resultMat: goog.vec.mat4d.Type): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function transpose(mat: goog.vec.mat4d.Type, resultMat: goog.vec.mat4d.Type): goog.vec.mat4d.Type;
     ...
     */
    export function determinant(mat: goog.vec.mat4d.Type): number;
     ...
     */
    export function invert(mat: goog.vec.mat4d.Type, resultMat: goog.vec.mat4d.Type): boolean;
     ...
     */
    export function equals(mat0: goog.vec.mat4d.Type, mat1: goog.vec.mat4d.Type): boolean;
     ...
     *     chained together.
     */
    export function multVec3(mat: goog.vec.mat4d.Type, vec: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    export function multVec3NoTranslate(mat: goog.vec.mat4d.Type, vec: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    export function multVec3Projective(mat: goog.vec.mat4d.Type, vec: goog.vec.vec3d.Type, resultVec: goog.vec.vec3d.Type): goog.vec.vec3d.Type;
     ...
     *     chained together.
     */
    export function multVec4(mat: goog.vec.mat4d.Type, vec: goog.vec.vec4d.Type, resultVec: goog.vec.vec4d.Type): goog.vec.vec4d.Type;
     ...
     *     chained.
     */
    export function makeTranslate(mat: goog.vec.mat4d.Type, x: number, y: number, z: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function makeScale(mat: goog.vec.mat4d.Type, x: number, y: number, z: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function makeRotate(mat: goog.vec.mat4d.Type, angle: number, ax: number, ay: number, az: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function makeRotateX(mat: goog.vec.mat4d.Type, angle: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function makeRotateY(mat: goog.vec.mat4d.Type, angle: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function makeRotateZ(mat: goog.vec.mat4d.Type, angle: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function makeFrustum(mat: goog.vec.mat4d.Type, left: number, right: number, bottom: number, top: number, near: number, far: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function makePerspective(mat: goog.vec.mat4d.Type, fovy: number, aspect: number, near: number, far: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function makeOrtho(mat: goog.vec.mat4d.Type, left: number, right: number, bottom: number, top: number, near: number, far: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function makeLookAt(mat: goog.vec.mat4d.Type, eyePt: goog.vec.vec3d.Type, centerPt: goog.vec.vec3d.Type, worldUpVec: goog.vec.vec3d.Type): goog.vec.mat4d.Type;
     ...
     */
    export function toLookAt(mat: goog.vec.mat4d.Type, eyePt: goog.vec.vec3d.Type, fwdVec: goog.vec.vec3d.Type, worldUpVec: goog.vec.vec3d.Type): boolean;
     ...
     *     chained.
     */
    export function makeEulerZXZ(mat: goog.vec.mat4d.Type, theta1: number, theta2: number, theta3: number): goog.vec.mat4d.Type;
     ...
     *     chained together.
     */
    export function toEulerZXZ(mat: goog.vec.mat4d.Type, euler: goog.vec.vec3d.Type, opt_theta2IsNegative?: boolean): goog.vec.vec4d.Type;
     ...
     *     chained.
     */
    export function translate(mat: goog.vec.mat4d.Type, x: number, y: number, z: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function scale(mat: goog.vec.mat4d.Type, x: number, y: number, z: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function rotate(mat: goog.vec.mat4d.Type, angle: number, x: number, y: number, z: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function rotateX(mat: goog.vec.mat4d.Type, angle: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function rotateY(mat: goog.vec.mat4d.Type, angle: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function rotateZ(mat: goog.vec.mat4d.Type, angle: number): goog.vec.mat4d.Type;
     ...
     *     chained.
     */
    export function getTranslation(mat: goog.vec.mat4d.Type, translation: goog.vec.vec3d.Type): goog.vec.vec3d.Type;
}
