...
declare module goog.html.silverlight {
     ...
     *
     */
    function createObject(source: goog.html.TrustedResourceUrl, opt_params?: {[index: string]: string}, opt_attributes?: {[index: string]: goog.html.SafeHtml.AttributeValue}): goog.html.SafeHtml;
}
