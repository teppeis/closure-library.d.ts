declare module goog.module {
    ...
    interface AbstractModuleLoader {
         ...
         *     module.
         */
        loadModules(ids: Array<string>, moduleInfoMap: {[index: string]: goog.module.ModuleInfo}, opt_successFn?: () => any, opt_errorFn?: (arg0: number) => any, opt_timeoutFn?: () => any, opt_forceReload?: boolean): void;
