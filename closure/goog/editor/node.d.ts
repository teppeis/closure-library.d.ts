declare module goog.editor.node {
     ...
     */
    export function isStandardsMode(node: Node): boolean;
     ...
     */
    export function getRightMostLeaf(parent: Node): Node;
     ...
     */
    export function getLeftMostLeaf(parent: Node): Node;
     ...
     */
    export function getFirstChild(parent: Node): Node;
     ...
     *     goog.editor.node.isImportant, or null if no such node exists.
     */
    export function getLastChild(parent: Node): Node;
     ...
     *     node exists.
     */
    export function getPreviousSibling(sibling: Node): Node;
     ...
     *     such node exists.
     */
    export function getNextSibling(sibling: Node): Node;
     ...
     */
    export function isImportant(node: Node): boolean;
     ...
     *     otherwise false.
     */
    export function isAllNonNbspWhiteSpace(textNode: Node): boolean;
     ...
     */
    export function isEmpty(node: Node, opt_prohibitSingleNbsp?: boolean): boolean;
     ...
     */
    export function findInChildren(parent: Node, hasProperty: (arg0: Node) => boolean): number;
     ...
     *     predicate function.
     */
    export function findHighestMatchingAncestor(node: Node, hasProperty: (arg0: Node) => boolean): Node;
    ...
    * Checks if node is a block-level html element. The <tt>display</tt> css
     ...
     */
    export function isBlockTag(node: Node): boolean;
     ...
     */
    export function skipEmptyTextNodes(node: Node): Node;
     ...
     */
    export function isEditableContainer(element: Node): boolean;
     ...
     */
    export function findTopMostEditableAncestor(node: Node, criteria: (arg0: Node) => boolean): Node;
     ...
     */
    export function splitDomTreeAt(currentNode: Node, opt_secondHalf?: Node, opt_root?: Node): Node;
     ...
     */
    export function transferChildren(newNode: Node, oldNode: Node): void;
     ...
     */
    export function replaceInnerHtml(node: Node, html: string): void;
}
