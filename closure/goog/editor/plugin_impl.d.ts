declare module goog {
    function require(name: 'goog.editor.PluginImpl'): typeof goog.editor.PluginImpl;
}
...
declare module goog.editor {
     ...
     * @package
     */
    class PluginImpl extends goog.events.EventTarget {
        constructor();
...
declare module goog.editor.PluginImpl {
