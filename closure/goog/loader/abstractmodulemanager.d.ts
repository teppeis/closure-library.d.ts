declare module goog {
    function require(name: 'goog.loader.AbstractModuleManager'): typeof goog.loader.AbstractModuleManager;
    function require(name: 'goog.loader.AbstractModuleManager.CallbackType'): typeof goog.loader.AbstractModuleManager.CallbackType;
    function require(name: 'goog.loader.AbstractModuleManager.FailureType'): typeof goog.loader.AbstractModuleManager.FailureType;
}

declare module goog.loader {
    ...
    class AbstractModuleManager {
         ...
         */
        setModuleTrustedUris(moduleUriMap: {[index: string]: Array<goog.html.TrustedResourceUrl>}): void;
         ...
         * @abstract
         */
        preloadModule(id: string, opt_timeout?: number): IThenable<any>;
         ...
         * @abstract
         */
        load(moduleId: string, opt_userInitiated?: boolean): IThenable<any>;
         ...
         * @abstract
         */
        loadMultiple(moduleIds: Array<string>, opt_userInitiated?: boolean): {[index: string]: IThenable<any>};
         ...
         */
        registerCallback(types: goog.loader.AbstractModuleManager.CallbackType|Array<goog.loader.AbstractModuleManager.CallbackType>, fn: Function): void;
    }
}

declare module goog.loader.AbstractModuleManager {
