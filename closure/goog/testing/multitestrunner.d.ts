declare module goog {
    function require(name: 'goog.testing.MultiTestRunner'): typeof goog.testing.MultiTestRunner;
    function require(name: 'goog.testing.MultiTestRunner.TestFrame'): typeof goog.testing.MultiTestRunner.TestFrame;
}
...
declare module goog.testing.MultiTestRunner {
     ...
     * @private
     */
    type StatsType_ = {testFile: string; success: boolean; runTime: number; totalTime: number; numFilesLoaded: number};
    ...
    class TestFrame extends goog.ui.Component {
         ...
         */
        getStats(): goog.testing.MultiTestRunner.StatsType_;
