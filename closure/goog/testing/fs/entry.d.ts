declare module goog {
    function require(name: 'goog.testing.fs.Entry'): typeof goog.testing.fs.Entry;
    function require(name: 'goog.testing.fs.DirectoryEntry'): typeof goog.testing.fs.DirectoryEntry;
    function require(name: 'goog.testing.fs.FileEntry'): typeof goog.testing.fs.FileEntry;
}
...
declare module goog.testing.fs {
     ...
     * @final
     */
    class DirectoryEntry extends goog.testing.fs.Entry {
        constructor(fs: goog.testing.fs.FileSystem, parent: goog.testing.fs.DirectoryEntry, name: string, children: {[index: string]: goog.testing.fs.Entry});
     ...
     * @final
     */
    class FileEntry extends goog.testing.fs.Entry {
