declare module goog {
    function require(name: 'goog.testing.dom'): typeof goog.testing.dom;
}
...
declare module goog.testing.dom {
     ...
     */
    function assertNodesMatch(it: goog.iter.Iterator<any>, array: Array<Node|number|string>): void;
     ...
     */
    function assertHtmlContentsMatch(htmlPattern: string, actual: Element, opt_strictAttributes?: boolean): void;
