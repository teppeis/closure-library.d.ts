declare module goog {
    function require(name: 'goog.testing.editor.TestHelper'): typeof goog.testing.editor.TestHelper;
}
...
declare module goog.testing.editor {
    ...
    class TestHelper extends goog.Disposable {
         ...
         */
        select(from: Node|string, fromOffset: number, opt_to?: Node|string, opt_toOffset?: number): goog.dom.AbstractRange;
    }
}
