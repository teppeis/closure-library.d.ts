declare module goog {
    function require(name: 'goog.testing.PerformanceTimer'): typeof goog.testing.PerformanceTimer;
    function require(name: 'goog.testing.PerformanceTimer.Task'): typeof goog.testing.PerformanceTimer.Task;
}
...
declare module goog.testing {
    ...
    class PerformanceTimer {
         ...
         * @return {number}
         */
        static median(samples: Array<number>): number;
...
declare module goog.testing.PerformanceTimer {
     ...
     */
    type TestFunction = () => goog.async.Deferred<any>|void;
