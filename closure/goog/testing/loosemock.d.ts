declare module goog {
    function require(name: 'goog.testing.LooseExpectationCollection'): typeof goog.testing.LooseExpectationCollection;
    function require(name: 'goog.testing.LooseMock'): typeof goog.testing.LooseMock;
}
