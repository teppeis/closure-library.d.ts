declare module goog {
    function require(name: 'goog.testing'): typeof goog.testing;
    function require(name: 'goog.testing.MethodMock'): typeof goog.testing.MethodMock;
}
...
declare module goog.testing.MethodMock {
     ...
     * @return {!goog.testing.MockInterface} The mocked method.
     */
    function fromObjectPropertyString(scopeFunctionName: goog.testing.ObjectPropertyString, opt_strictness?: number): goog.testing.MockInterface;
