declare module goog {
    function require(name: 'goog.testing.MockClassRecord'): typeof goog.testing.MockClassRecord;
    function require(name: 'goog.testing.MockClassFactory'): typeof goog.testing.MockClassFactory;
}
...
declare module goog.testing {
    ...
    class MockClassRecord {
         ...
         */
        getStaticMock(): goog.testing.StrictMock|goog.testing.LooseMock|void;
         ...
         */
        addMockInstance(args: Array<any>, mock: goog.testing.StrictMock|goog.testing.LooseMock): void;
         ...
         */
        findMockInstance(args: Array<any>): goog.testing.StrictMock|goog.testing.LooseMock|void;
