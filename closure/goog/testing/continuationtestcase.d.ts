declare module goog {
    function require(name: 'goog.testing.ContinuationTestCase'): typeof goog.testing.ContinuationTestCase;
    function require(name: 'goog.testing.ContinuationTestCase.ContinuationTest'): typeof goog.testing.ContinuationTestCase.ContinuationTest;
    function require(name: 'goog.testing.ContinuationTestCase.Step'): typeof goog.testing.ContinuationTestCase.Step;
}
...
declare module goog.testing {
    ...
    class ContinuationTestCase extends goog.testing.TestCase {
         ...
         *     fires.
         */
        waitForEvent(eventTarget: goog.events.EventTarget|goog.globalEventTarget, eventType: string, continuation: () => any): void;
         ...
         */
        waitForCondition(condition: Function, continuation: () => any, opt_interval?: number, opt_maxTimeout?: number): void;
    }
}
...
declare module goog.testing.ContinuationTestCase {
     ...
     * @final
     */
    class ContinuationTest extends goog.testing.TestCase.Test {
    ...
    class Step extends goog.testing.TestCase.Test {
        constructor(name: string, ref: () => any, opt_scope?: Object);
