declare module goog {
    function require(name: 'goog.testing.AsyncTestCase'): typeof goog.testing.AsyncTestCase;
    function require(name: 'goog.testing.AsyncTestCase.ControlBreakingException'): typeof goog.testing.AsyncTestCase.ControlBreakingException;
}
...
declare module goog.testing {
    ...
    class AsyncTestCase extends goog.testing.TestCase {
         ...
         * @protected
         */
        activeTest: goog.testing.TestCase.Test|void;
...
declare module goog.testing.AsyncTestCase {
     ...
     * @private
     */
    type TopStackFuncResult_ = {controlBreakingExceptionThrown: boolean; message: string};
