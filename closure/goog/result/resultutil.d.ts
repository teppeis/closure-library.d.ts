declare module goog {
    function require(name: 'goog.result'): typeof goog.result;
}
...
declare module goog.result {
     ...
     * @private
     */
    interface DependentResultImpl_ extends goog.result.SimpleResult {
     ...
     * @template T
     */
    function wait<T>(result: goog.result.Result, handler: (arg0: goog.result.Result) => any, opt_scope?: T): void;
     ...
     * @template T
     */
    function waitOnSuccess<T>(result: goog.result.Result, handler: (arg0: any, arg1: goog.result.Result) => any, opt_scope?: T): void;
     ...
     * @template T
     */
    function waitOnError<T>(result: goog.result.Result, handler: (arg0: any, arg1: goog.result.Result) => any, opt_scope?: T): void;
     ...
     */
    function transform(result: goog.result.Result, transformer: (arg0: any) => any): goog.result.DependentResult;
     ...
     * @template T
     */
    function chain<T>(result: goog.result.Result, actionCallback: (arg0: goog.result.Result) => goog.result.Result, opt_scope?: T): goog.result.DependentResult;
